    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/register", "/api/auth/login", "/api/auth/otp/request", "/api/auth/otp/verify").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/destinations/**", "/api/hotels/**", "/api/reviews/destination/**", "/api/places/**", "/api/routes/**").permitAll()
                .requestMatchers(HttpMethod.POST, "/api/places/import").permitAll()
                .requestMatchers("/error").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/bookings/hotel-manager").hasAuthority("ROLE_HOTEL_MANAGER")
